...
void canOpenInit(void)
{
    ...
    uint16_t message_sdo[PRESETSDOLENG][10] = {
      ...
      {0x608, 0x23, 0x00, 0x16, 0x01, 0x10, 0x00, 0x40, 0x60, uint8}, // 映射为状态字 0x6040
      ...
      {0x608, 0x23, 0x00, 0x1A, 0x01, 0x10, 0x00, 0x40, 0x60, uint8}, // 映射为控制字 0x6040
      ...
      {0x608, 0x23, 0x01, 0x14, 0x01, 0x88, 0x03, 0x00, 0x80, uint8}, // TPDO2 失能
      {0x608, 0x2f, 0x01, 0x14, 0x02, 0x64, 0x00, 0x00, 0x00, uint8}, // TPDO2 传输类型 周期触发
      {0x608, 0x23, 0x02, 0x14, 0x01, 0x88, 0x04, 0x00, 0x80, uint8}, // TPDO2 失能
      {0x608, 0x2f, 0x02, 0x14, 0x02, 0x64, 0x00, 0x00, 0x00, uint8}, // TPDO2 传输类型 
      {0x608, 0x23, 0x03, 0x14, 0x01, 0x88, 0x05, 0x00, 0x80, uint8}, // TPDO2 失能
