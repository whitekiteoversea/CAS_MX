...
void canOpenInit(void)
{
    ...
    uint16_t message_sdo[PRESETSDOLENG][10] = {
      ...
      {0x608, 0x2f, 0x01, 0x16, 0x00, 0x02, 0x00, 0x00, 0x00, uint8}, // TPDO2 映射清零
      {0x608, 0x23, 0x01, 0x14, 0x01, 0x88, 0x03, 0x00, 0x00, uint8}, // TPDO2 使能

      // TPDO3-4
      {0x608, 0x23, 0x02, 0x14, 0x01, 0x88, 0x04, 0x00, 0x80, uint8}, // TPDO3 失能
      {0x608, 0x2f, 0x02, 0x14, 0x02, 0x64, 0x00, 0x00, 0x00, uint8}, // TPDO3 传输类型 
      {0x608, 0x23, 0x03, 0x14, 0x01, 0x88, 0x05, 0x00, 0x80, uint8}, // TPDO4 失能
